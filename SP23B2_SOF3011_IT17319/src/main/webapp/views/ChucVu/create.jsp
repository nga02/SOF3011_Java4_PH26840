...
<div class="col-8 offset-2 mt-3">
    ...
    <form name="myForm" method="POST"
          action="/SP23B2_SOF3011_IT17319_war_exploded/chuc-vu/store">
        <div class="form-group">
            <label>Mã</label>
            <input type="text" name="ma" class="form-control" onkeyup="Validate()" required/>
            <p id="error_ma"></p>
        </div>
        <div class="form-group">
            <label>Tên</label>
            <input type="text" name="ten" class="form-control" onkeyup="Validate()" required/>
            <p id="error_ten"></p>
        </div>
        <div class="mt-2">
            <div class="col-6">
